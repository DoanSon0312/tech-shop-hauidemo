...
public interface IProductService {
    ...
    Page<Product> findActiveProducts(int pageNumber, int pageSize);
    ...
    Map<String, Object> getTopSellingCategories();
    ...
    boolean permanentDeleteProduct(Long productId);
    Page<Product> getAllActiveProducts(int pageNumber, int pageSize);

    long countProductsToAutoDelete();

...
import com.haui.tech_shop.repositories.BrandRepository;
...
public class BrandServiceImpl implements IBrandService {
    ...
    @Override
    public List<Brand> findByIdAsList(Long id) {
        return brandRepository.findById(id)
                .map(Collections::singletonList) // chuyển Brand thành List<Brand>
                .orElse(Collections.emptyList()); // nếu không có thì trả list rỗng
    }
}

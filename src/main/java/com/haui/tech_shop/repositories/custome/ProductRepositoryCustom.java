package com.haui.tech_shop.repositories.custome;
...
public class ProductRepositoryCustom {
    public static Specification<Product> filter(ProductFilterBuilder builder) {
        return (root, query, criteriaBuilder) -> {
            ...
            // THÊM: Filter theo active (ưu tiên cao nhất)
            if (builder.getActive() != null) {
                predicates.add(criteriaBuilder.equal(root.get("active"), builder.getActive()));
            }

...
import com.haui.tech_shop.services.Impl.CampaignSimulationService;
...
public class VoucherController {
    ...
    @Autowired
    private CampaignSimulationService simulationService;
    @GetMapping("")
    ...
    public ResponseEntity<Map<String, Object>> simulateCampaign(
        ...
        String campaignDescription = request.get("campaignDescription");
        Map<String, Object> simulationResult = simulationService.simulateCampaign(campaignDescription);

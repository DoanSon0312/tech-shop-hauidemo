...
import com.haui.tech_shop.dtos.requests.RatingRequest;
...
public class ProductController {
    ...
    public String productDetail(Model model, @PathVariable Long id) {
        ...
        List<FinancePartner> financePartners = installmentService.getAllActiveFinancePartners();
        List<InstallmentPlan> installmentPlans = installmentService.getInstallmentPlansByProduct(id);

        model.addAttribute("financePartners", financePartners);
        model.addAttribute("installmentPlans", installmentPlans);
